 ...
 */
export function getEquivalentSlug(currentSlug: string, targetLocale: string): string | null {
 ...
 */
export function hasTranslation(currentSlug: string, targetLocale: string): boolean {
