...
const translations = {
    en: {
        ...
        description: "Please try again. If the problem persists, feel free to reach out via the contact page.",
        tryAgain: "Try Again",
        goHome: "Go Home",
    ...
    fr: {
        ...
        description: "Veuillez réessayer. Si le problème persiste, n'hésitez pas à nous contacter via la page de contact.",
        tryAgain: "Réessayer",
...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }, reset: () => void }) {
    ...
    const contactLink = (mounted && locale === 'fr') ? '/fr/contact' : '/en/contact'
            ...
            <main className="w-full px-6 py-20">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link href={homeLink} className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                            {t.goHome}
                        </Link>
                        <Link href={contactLink} className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                            {t.contactMe}
                        </Link>
                    </div>
                </div>
