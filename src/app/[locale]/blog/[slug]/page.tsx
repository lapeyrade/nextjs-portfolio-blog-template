...
import { PageTransition, FadeInUp, ScrollReveal } from '@/components/animations'
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <FadeInUp delay={0.2}>
                            <div className="flex items-center gap-4 text-sm text-gray-400 mb-6">
                                ...
                                <span>•</span>
                                <span>{new Intl.NumberFormat(locale === 'fr' ? 'fr-FR' : 'en-US').format(post.wordCount)} {t('post.words')}</span>
                                <span>•</span>
