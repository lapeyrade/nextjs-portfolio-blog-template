...
import {
	createObfuscatedMailtoLink,
	obfuscateEmailForDisplay,
	openObfuscatedEmail,
} from "@/lib/emailUtils";
...
export default function ObfuscatedEmail({
	...
	// Generate unique ID for copy icon
	const copyIconTitleId = useId();
			...
			{isRevealed && (
				...
				>
					<svg
						...
						viewBox="0 0 24 24"
						role="img"
						aria-labelledby={copyIconTitleId}
					>
						<title id={copyIconTitleId}>Copy email</title>
						<path
							strokeLinecap="round"
